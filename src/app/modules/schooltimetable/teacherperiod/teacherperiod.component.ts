...
export class TeacherperiodComponent implements OnInit {
  ...
  PageLoad() {
    ...
    if (this.LoginUserDetail == null)
      ...
      var perObj = globalconstants.getPermission(this.tokenStorage, globalconstants.Pages.edu.TIMETABLE.TEACHERPERIOD)
      if (perObj.length > 0)
        this.Permission = perObj[0].permission;
      if (this.Permission != 'deny') {
        this.FilterOrgSubOrgBatchId = globalconstants.getOrgSubOrgBatchIdFilter(this.tokenStorage);
        this.FilterOrgSubOrg = globalconstants.getOrgSubOrgFilter(this.tokenStorage);
        this.Classes = this.tokenStorage.getAllClasses()!;
